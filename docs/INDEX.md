...
2. [PLUGIN_INSTALL.md](./PLUGIN_INSTALL.md)
3. [AGENT_RESOURCE_OFFICER_EXTERNAL_AGENTS.md](./AGENT_RESOURCE_OFFICER_EXTERNAL_AGENTS.md)
4. 如果 `MoviePilot` 不在当前机器，再看 [AGENT_RESOURCE_OFFICER_REMOTE_DEPLOY.md](./AGENT_RESOURCE_OFFICER_REMOTE_DEPLOY.md)

## 我现在要接外部智能体

1. [skills/agent-resource-officer/SKILL.md](../skills/agent-resource-officer/SKILL.md)
2. [skills/agent-resource-officer/README.md](../skills/agent-resource-officer/README.md)
3. [AGENT_RESOURCE_OFFICER_EXTERNAL_AGENTS.md](./AGENT_RESOURCE_OFFICER_EXTERNAL_AGENTS.md)
4. 如果跨机器，再看 [AGENT_RESOURCE_OFFICER_REMOTE_DEPLOY.md](./AGENT_RESOURCE_OFFICER_REMOTE_DEPLOY.md)
